...
struct MealCategories: Codable, Hashable {
...
struct MealsData: Codable, Hashable, RandomAccessCollection {
  let meals: [Meals]

  // Conform to RandomAccessCollection protocol
  var startIndex: Int { meals.startIndex }
  var endIndex: Int { meals.endIndex }
